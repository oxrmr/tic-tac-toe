...
import { UIButton, UIButtonSizes, UIButtonVariants } from '@/app/uikit/ui-button/ui-button';
  ...
  return (
    ...
    >
      ...
      <UIModal.Body>
        ...
        <div className={'shadow-xs mb-4 grid grid-cols-2 gap-4 rounded-2xl bg-white px-8 py-4'}>
          {props.playersList}
        </div>
      </UIModal.Body>
      <UIModal.Footer>
